...
public class CazadorTest {
    ...
    public void setup() throws ExperienciaNegativaArgumentException {
        ...
        cazadorSigiloso= new CazadorSigiloso("Cazador Sigiloso", 40);
        cazadorRural= new CazadorRural("Cazador Rural", 30);
        cazadorUrbano= new CazadorUrbano("Cazador Urbano", 20);
    ...
    @Test
    public void cazadorRuralpuedeCapturarSiProfugoEsNerviosoYtieneInocenciaMenoraExperiencia() throws HabilidadInvalidaException, InocenciaInvalidaException {
        Profugo profugo = new Profugo("Jose", 20, true, 40); 
        assertTrue(cazadorRural.puedeCapturar(profugo)); 
    }
    
    @Test
    public void cazadorRuralNoPuedeCapturarSiProfugoNoEsNervioso() throws HabilidadInvalidaException, InocenciaInvalidaException {
        Profugo profugo = new Profugo("Jose", 20, false, 40);
        assertFalse(cazadorRural.puedeCapturar(profugo));
    }
    
    @Test
    public void cazadorRuralNoPuedeCapturarSiInocenciaEsMayorOIgualQueExperienciaAExperiencia() throws HabilidadInvalidaException, InocenciaInvalidaException {
        Profugo profugo = new Profugo("Jose", 30, true, 40);
        assertFalse(cazadorRural.puedeCapturar(profugo)); 
    }
    
    @Test
    public void cazadorSigilosoPuedeCapturarSiHabilidadMenorA50EInocenciaMenorAExperiencia() throws HabilidadInvalidaException, InocenciaInvalidaException {
        Profugo profugo = new Profugo("Luis", 20, true, 39);
        assertTrue(cazadorSigiloso.puedeCapturar(profugo)); 
    }
    
    @Test
    public void cazadorUrbanoPuedeCapturarSiProfugoNoEsNervioso() throws HabilidadInvalidaException, InocenciaInvalidaException {
        Profugo profugo = new Profugo("Ana", 10, false, 50);
        assertTrue(cazadorUrbano.puedeCapturar(profugo)); 
    }
	
    @Test
    public void cazadorUrbanoCalmaAlProfugoAlIntimidarlo() throws HabilidadInvalidaException, InocenciaInvalidaException {
    ...
    @Test
    public void cazadorSigilosoReduceHabilidadAlIntimidar() throws HabilidadInvalidaException, InocenciaInvalidaException {
